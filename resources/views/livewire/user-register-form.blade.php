        ...
        <div class="mt-4">
            <form wire:submit.prevent='createNewUser' action="#" method="POST" class="space-y-6">
                ...
                <div class="col-span-full">
                    <label for="profile-picture" class="block text-sm/6 font-medium text-white">Profile
                        Picture</label>
                ...
                @if ($avatar)
                    <div class="mt-2">
                        <p class="text-sm font-medium text-gray-900 mb-2">Photo Preview:</p>
                        <img src="{{ $avatar->temporaryUrl() }}" alt="Photo Preview" class="h-20 w-20 object-cover">
                    </div>
                @endif
